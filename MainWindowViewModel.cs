...
namespace VOS
{
    class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        private void Init()
        {
            ...
            list.Add(new string[] { 
                "hey vos","vos", "hey there", "hi vos",
                "can you hear me","can i ask for something","can you help me",
                "stop","cancel","stop listening","i'm done","sleep",
                "restart","restart program",
                "exit","exit program","close","close application","close program",
                "help me","i need help","help me",
                "shutdown","shutdown system","shutdown computer","can you shutdown the computer",
                "restart system","restart computer","can you restart the computer",
                "hibernate","hibernate computer","hibernate system","can you put the computer to hibernation mode",
                "go to sleep", "can you put the computer to sleep",
                "time","what is the time", "tell me the time",
                "day" , "what is today",
                "date", "what is the date today", "tell me the date",
                "year", "what year is it"  , "what is this year"  , "tell me the year",
                "location"  , "where am i?" , "what is my current location",
                "weather", "what is it like outside", "what is the weather " , "what is the weather today",
                "volume up", "increase volume",
                "volume max",
                "volume down"  , "decrease volume",
                "mute" , "can you mute",
                "unmute", "can you unmute",
                "num lock on", "turn num lock on",
                "num lock off", "turn num lock off",
                "caps on", "cap lock on",
                "caps off", "cap lock off",
                "brightness up" , "increase brightness", "turn up brightnesss",
                "brightness down", "decrease brightness", "turn down brightness",
                "acrobat", "access","antivirius","brave","c lion",
                "discord","edge", "eclipse", "excel","git", 
                "chrome", "intellij", "itunes", "m audio",  "nord vpn", 
                "nord pass","note", "pad plus plus", "outlook", "paint",
                "powershell", "powerpoint", "publisher", "pycharm" ,"privado vpn",
                "r studio", "reaper", "safewatch", "steam","visual studio", 
                "v s code",  "vlc", "word",  "web storm" ,"winrar",
                "zoom","calculator","terminal","screenshot","copy", 
                "paste","new window","new tab","search page","close tab",
                "close window","bookmark page","print page","new private tab","reopen tab",
                "refresh page", "file explorer", "lock computer","settings","full screen",
                "pause playing","continue playing","previous track", "previous video","previous song",
                "next track","next video","next song","zoom in","zoom out",
                "debug","debug again","stop debugging"
            });
